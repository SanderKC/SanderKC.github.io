...
<h3>Introduction</h3>
This robot is an autonomus sorting system intended for insects samples from greenland. The device is build on platform, which is also a drawer that allows users egonomical access to samples before and after sorting. The project was started in the summer of 2023 as a bachelor's project and the foundation for my employment at Aarhus Univerty, where i continued to develop and improve abon the design. 
